...
When building production-grade machine learning (ML) pipelines, it is important
to understand and track the lineage of the various artifacts involved in your ML
pipeline. ML models have metadata associated with them that provide this data.
You can think of this metadata as the equivalent of stack traces in software
development. [ML Metadata (MLMD)](https://github.com/google/ml-metadata) is a
library for recording and retrieving metadata associated with ML developer and
